      ...
      <div className="panelview__scroll">
        ...
        {friends.length > 0 ? (
          ...
          <p className="profile__friends-empty">
            Поделись событием через «Пойдём?» — кто примет, попадёт в заявки. Подтвердишь — будете видеть,
            что друг у друга в избранном. А если вы пригласили друг друга, подружитесь сразу.
          </p>
        )}
