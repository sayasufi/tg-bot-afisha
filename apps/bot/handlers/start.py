...
SUGGEST_MSG = (
    f"{ce('📍')} <b>Добавить своё</b>\n\n"
    "Открой приложение → <b>Профиль</b> → раздел <b>«Добавить»</b>:\n"
    "• <b>Предложить событие</b> — если знаешь событие, которого ещё нет на карте;\n"
    "• <b>Добавить свой канал</b> — если ведёшь TG-канал площадки, и хочешь, чтобы мы "
    "собирали афишу оттуда автоматически.\n\n"
    "Всё проходит быструю модерацию. Если что-то не так или есть вопрос — напиши менеджеру."
)
